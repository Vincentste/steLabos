...
function getMenuCrea(){
     $.getJSON("dispatcher.php","op=data_recherche",function(d){
        var createurs=d['createurs'];
        $(".modal-body-menu").children().remove();
        $(".msg").remove();
        $("<section><ul class=crea></ul></section>").appendTo(".modal-body-menu");
        for (var i = 0; i <createurs.length; i++){
...
//annuler 
$("#myModalMenu").on("click",".annule",function fermeModal(e){
    $(".modal-body-menu>input").val("")
});
//ferme la modal 
